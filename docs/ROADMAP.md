...
- 让 README 首屏更清楚地表达“Excel 商品数据 -> 批量 PSD 成品”的生产价值。
- 补齐 Demo、发布素材、Issue 模板和公开讨论入口。
- 建立 V3.0.0 Release，给外部分享一个稳定落点。
- 收集第一批真实电商模板、导出失败和文档困惑。

...
test('开源版本应默认展示公开店铺选购入口并保留可配置能力', () => {
  ...
  assert.ok(appMeta.includes('APP_DEFAULT_SHOP_URL'));
  assert.ok(appMeta.includes('https://pay.ldxp.cn/shop/FTIWLFHQ'));
  ...
  assert.ok(envExample.includes('VITE_SHOP_URL=https://pay.ldxp.cn/shop/FTIWLFHQ'));
